...
function global_theme_styles() {
	...
	wp_enqueue_style( 'think-shift-global-theme-style', get_template_directory_uri() . '/css/global.css', array(), $css_version );
}
...
function front_end_scripts() {
	...
	wp_enqueue_script( 'think-shift-front-end-scripts', get_template_directory_uri() . '/js/scripts.js', $dependencies, $asset_file['version'], true );
}
add_action( 'wp_enqueue_scripts', __NAMESPACE__ . '\front_end_scripts' );


add_action('wp_enqueue_scripts', function() {
    // Global styles generated from theme.json
    wp_enqueue_style(
        'think-shift-global-styles',
        wp_get_global_stylesheet(), // This outputs theme.json styles
        [],
...
function enqueue_editor_modifications() {
	...
	wp_enqueue_script( 'think-shift-editor-modifications', get_template_directory_uri() . '/js/editor.js', $dependencies, $asset_file['version'], true );
}
